                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" name="login" class="mb-3" action="/login" method="POST">
                            <fieldset disabbled>
                                ...
                                <input type="text" class="form-control" disabled id="email-phone" name="email-phone" placeholder="Enter your email or Phone" autofocus required />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control disabled" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" required />
