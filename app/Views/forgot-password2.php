        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="text-center">
              ...
              <p class="mb-4">Step 2 of 3.</p>
            </div>
            <form id="formAuthentication" class="mb-3" method="POST" action="/login/verify-otp" method="">
              <div class="mb-3">
                <label for="email-phone" class="form-label">OTP</label>
                <input type="text" class="form-control" id="OTP" name="OTP" placeholder="Please Enter the OTP sent to your phone" autofocus required />
              </div>
              <div class="mb-3">
                <div class="row">
